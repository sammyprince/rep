...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var DEF_DEFAULTS = {
        ...
        classNames: 'fc-non-law_firm',
        groupId: '_law_firmHours',
    };
    /*
    TODO: pass around as EventDefHash!!!
    */
    function parseLawFirmHours(input, context) {
    ...
    var Splitter = /** @class */ (function () {
        ...
        Splitter.prototype.splitProps = function (props) {
            ...
            for (var key in keyInfos) {
                ...
                splitProps[key] = {
                    law_firmHours: keyInfo.law_firmHours || props.law_firmHours,
    ...
    */
    ...
    function isNewPropsValid(newProps, context) {
        ...
        var props = __assign({ law_firmHours: calendarState.law_firmHours, dateSelection: '', eventStore: calendarState.eventStore, eventUiBases: calendarState.eventUiBases, eventSelection: '', eventDrag: null, eventResize: null }, newProps);
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            // constraint
            if (!allConstraintsPass(subjectConfig.constraints, subjectRange, otherEventStore, state.law_firmHours, context)) {
                return false;
            }
            // overlap
    ...
    function isDateSelectionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        // constraint
        if (!allConstraintsPass(selectionConfig.constraints, selectionRange, relevantEventStore, state.law_firmHours, context)) {
            return false;
        }
        // overlap
    ...
    // Constraint Utils
    // ------------------------------------------------------------------------------------------------------------------------
    function allConstraintsPass(constraints, subjectRange, otherEventStore, law_firmHoursUnexpanded, context) {
        for (var _i = 0, constraints_1 = constraints; _i < constraints_1.length; _i++) {
            var constraint = constraints_1[_i];
            if (!anyRangesContainRange(constraintToRanges(constraint, subjectRange, otherEventStore, law_firmHoursUnexpanded, context), subjectRange)) {
                return false;
            }
        }
        return true;
    }
    function constraintToRanges(constraint, subjectRange, // for expanding a recurring constraint, or expanding law_firm hours
    otherEventStore, // for if constraint is an even group ID
    law_firmHoursUnexpanded, // for if constraint is 'law_firmHours'
    context) {
        if (constraint === 'law_firmHours') {
            return eventStoreToRanges(expandRecurring(law_firmHoursUnexpanded, subjectRange, context));
        }
    ...
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        function CalendarDataManager(props) {
            ...
            this.parseContextLawFirmHours = memoizeObjArg(parseContextLawFirmHours);
            ...
            var initialState = {
                ...
                law_firmHours: this.parseContextLawFirmHours(calendarContext),
    ...
    function parseContextLawFirmHours(calendarContext) {
        return parseLawFirmHours(calendarContext.options.law_firmHours, calendarContext);
    }
    ...
    */
        ...
        */
        ...
        CalendarContent.prototype.renderView = function (props) {
            ...
            var viewProps = {
                ...
                law_firmHours: props.law_firmHours,
    ...
    var Slicer = /** @class */ (function () {
        function Slicer() {
            this.sliceLawFirmHours = memoize(this._sliceLawFirmHours);
        ...
        Slicer.prototype.sliceProps = function (props, dateProfile, nextDayThreshold, context) {
            ...
            return {
                ...
                law_firmHourSegs: this.sliceLawFirmHours.apply(this, __spreadArrays([props.law_firmHours, dateProfile, nextDayThreshold, context], extraArgs)),
        ...
        Slicer.prototype._sliceLawFirmHours = function (law_firmHours, dateProfile, nextDayThreshold, context) {
            var extraArgs = [];
            for (var _i = 4; _i < arguments.length; _i++) {
                extraArgs[_i - 4] = arguments[_i];
            }
            ...
            return this._sliceEventStore.apply(this, __spreadArrays([expandRecurring(law_firmHours, computeActiveRange(dateProfile, Boolean(nextDayThreshold)), context),
                {},
                dateProfile,
    ...
    */
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.render = function () {
            ...
            var law_firmHoursByCol = splitSegsByFirstCol(props.law_firmHourSegs, colCnt);
                ...
                props.cells.map(function (cell, col) {
                    ...
                    return (createElement(TableCell, { key: cell.key, elRef: _this.cellElRefs.createRef(cell.key), innerElRef: _this.frameElRefs.createRef(cell.key) /* FF <td> problem, but okay to use for left/right. TODO: rename prop */, dateProfile: props.dateProfile, date: cell.date, showDayNumber: props.showDayNumbers, showWeekNumber: props.showWeekNumbers && col === 0, forceDayTop: props.showWeekNumbers /* even displaying weeknum for row, not necessarily day */, todayRange: props.todayRange, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, moreCnt: moreCnts[col], buildMoreLinkText: props.buildMoreLinkText, onMoreClick: function (arg) {
                        ...
                        createElement(Fragment, null,
                            ...
                            _this.renderFillSegs(law_firmHoursByCol[col], 'non-law_firm'),
    ...
    var Table = /** @class */ (function (_super) {
        ...
        function Table() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.splitLawFirmHourSegs = memoize(splitSegsByRow);
        ...
        Table.prototype.render = function () {
            ...
            var law_firmHourSegsByRow = this.splitLawFirmHourSegs(props.law_firmHourSegs, rowCnt);
                ...
                createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement(Fragment, null,
                    createElement("table", { className: "fc-scrollgrid-sync-table", style: {
                        ...
                        createElement("tbody", null, props.cells.map(function (cells, row) { return (createElement(TableRow, { ref: _this.rowRefs.createRef(row), key: cells.length
                            ...
                            , showDayNumbers: rowCnt > 1, showWeekNumbers: props.showWeekNumbers, todayRange: todayRange, dateProfile: dateProfile, cells: cells, renderIntro: props.renderRowIntro, law_firmHourSegs: law_firmHourSegsByRow[row], eventSelection: props.eventSelection, bgEventSegs: bgEventSegsByRow[row].filter(isSegAllDay) /* hack */, fgEventSegs: fgEventSegsByRow[row], dateSelectionSegs: dateSelectionSegsByRow[row], eventDrag: eventDragByRow[row], eventResize: eventResizeByRow[row], dayMaxEvents: dayMaxEvents, dayMaxEventRows: dayMaxEventRows, clientWidth: props.clientWidth, clientHeight: props.clientHeight, buildMoreLinkText: buildMoreLinkText, onMoreClick: function (arg) {
    ...
    var DayTableView = /** @class */ (function (_super) {
        ...
        DayTableView.prototype.render = function () {
            ...
            var bodyContent = function (contentArg) { return (createElement(DayTable, { ref: _this.tableRef, dateProfile: props.dateProfile, dayTableModel: dayTableModel, law_firmHours: props.law_firmHours, dateSelection: props.dateSelection, eventStore: props.eventStore, eventUiBases: props.eventUiBases, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, nextDayThreshold: options.nextDayThreshold, colGroupNode: contentArg.tableColGroupNode, tableMinWidth: contentArg.tableMinWidth, dayMaxEvents: options.dayMaxEvents, dayMaxEventRows: options.dayMaxEventRows, showWeekNumbers: options.weekNumbers, expandRows: !props.isHeightAuto, headerAlignElRef: _this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint })); };
    ...
    */
            ...
            return (createElement(DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) { return (createElement("td", __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-timegrid-col-frame" },
                    createElement("div", { className: "fc-timegrid-col-bg" },
                        _this.renderFillSegs(props.law_firmHourSegs, 'non-law_firm'),
    ...
    var TimeColsContent = /** @class */ (function (_super) {
        ...
        function TimeColsContent() {
            ...
            _this.splitLawFirmHourSegs = memoize(splitSegsByCol);
        ...
        TimeColsContent.prototype.render = function () {
            ...
            var law_firmHourSegsByRow = this.splitLawFirmHourSegs(props.law_firmHourSegs, colCnt);
                ...
                createElement("table", { style: {
                    ...
                    createElement("tbody", null,
                        createElement("tr", null,
                            ...
                            props.cells.map(function (cell, i) { return (createElement(TimeCol, { key: cell.key, elRef: _this.cellElRefs.createRef(cell.key), dateProfile: props.dateProfile, date: cell.date, nowDate: props.nowDate, todayRange: props.todayRange, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, fgEventSegs: fgEventSegsByRow[i], bgEventSegs: bgEventSegsByRow[i], law_firmHourSegs: law_firmHourSegsByRow[i], nowIndicatorSegs: nowIndicatorSegsByRow[i], dateSelectionSegs: dateSelectionSegsByRow[i], eventDrag: eventDragByRow[i], eventResize: eventResizeByRow[i], slatCoords: props.slatCoords, eventSelection: props.eventSelection, forPrint: props.forPrint })); }))))));
        };
    ...
    var TimeCols = /** @class */ (function (_super) {
        ...
        TimeCols.prototype.render = function () {
            ...
            return (createElement("div", { className: "fc-timegrid-body", ref: props.rootElRef, style: {
                ...
                createElement(TimeColsContent, { cells: props.cells, axis: props.axis, dateProfile: props.dateProfile, law_firmHourSegs: props.law_firmHourSegs, bgEventSegs: props.bgEventSegs, fgEventSegs: props.fgEventSegs, dateSelectionSegs: props.dateSelectionSegs, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, todayRange: props.todayRange, nowDate: props.nowDate, nowIndicatorSegs: props.nowIndicatorSegs, clientWidth: props.clientWidth, tableMinWidth: props.tableMinWidth, tableColGroupNode: props.tableColGroupNode, slatCoords: state.slatCoords, onColCoords: this.handleColCoords, forPrint: props.forPrint })));
        };
    ...
    */
    ...
    exports.parseLawFirmHours = parseLawFirmHours;
