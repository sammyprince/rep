                          ...
                          <div class="col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                ...
                                >
                                <br />
                                <select class="form-control" v-model="form.appointment_type_id">
                                    <option :value="at.id" v-for="at in appointment_type" v-html="at.display_name"></option>
                                </select>
                              </div>
                              <div class="col-md-3">
                                <label class="fs-6 fw-bold text-capitalize">
                                ...
                                >
                                <br />
                                <input type="number" class="form-control" v-model="form.fee">
                              </div>
                            </div>
                          </div>
