                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div v-if="form.link_type =='internal' && form.file_type == 'audio'" class="form-group mb-3">
                            ...
                            <input id="lawyer-audio" @change="onBroadcastFileChange($event,'audio')" type="file" />
                        ...
                        <div v-if="form.link_type =='internal' && form.file_type == 'video'" class="form-group mb-3">
                            ...
                            <input id="lawyer-video" @change="onBroadcastFileChange($event,'video')" type="file" />
...
export default defineComponent({
    ...
    methods:{
        ...
        create(){
            this.form.post(this.route('lawyers.lawyer_broadcasts.store'), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
        ...
        update(){
            this.form.transform((data) => ({
                    ...data,
                    _method: "PUT",
                })).post(this.route('lawyers.lawyer_broadcasts.update',{lawyer_broadcast:this.modalData.id}), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
