    ...
    <Modal maxWidth="lg" :id="id">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <Multiselect v-model="form.tag_ids" valueProp="id" label="name" mode="tags" :close-on-select="false" :searchable="false"
                ...
                <div v-if="form.link_type =='internal' && form.file_type == 'audio'" class="form-group mb-3">
                    ...
                    <input id="lawyer-audio" @change="onPodcastFileChange($event,'audio')" type="file" />
                ...
                <div v-if="form.link_type =='internal' && form.file_type == 'video'" class="form-group mb-3">
                    ...
                    <input id="lawyer-video" @change="onPodcastFileChange($event,'video')" type="file" />
                ...
                <div class="form-group mb-3">
                    ...
                    <input id="lawyer-image" class="w-100 custom-file-input"  ref="formImage"  @change="onFileChange" type="file" />
                <div>
...
export default defineComponent({
    ...
    methods:{
        ...
        create(){
            this.form.post(this.route('lawyers.lawyer_podcasts.store'), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
        ...
        update(){
            this.form.transform((data) => ({
                    ...data,
                    _method: "PUT",
                })).post(this.route('lawyers.lawyer_podcasts.update',{lawyer_podcast:this.modalData.id}), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
