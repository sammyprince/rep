          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group mb-3">
                ...
                <Multiselect v-model="form.tag_ids" valueProp="id" label="name" mode="tags" :close-on-select="false"
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label for="ends_at">{{ __("ends at") }}</label>
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input v-model="form.address_line_1" class="w-100 form-control px-3"
                  :class="{ 'is-invalid': form.errors.address_line_1 }" placeholder="Please Enter" type="text" />
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input v-model="form.address_line_2" class="w-100 form-control px-3"
                  :class="{ 'is-invalid': form.errors.address_line_2 }" placeholder="Please Enter" type="text" />
...
export default defineComponent({
  ...
  methods: {
    ...
    create() {
      this.form.post(this.route('lawyers.lawyer_events.store'), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
  ...
  update() {
    this.form
      ...
      .post(
        this.route("lawyers.lawyer_events.update", {
          lawyer_event: this.modalData.id,
        }),
        {
          preserveState: true,
          preserveScroll: true,
