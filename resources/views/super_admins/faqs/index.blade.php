            ...
            <div class="row align-items-center mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-md-5">
                    <div class="d-flex justify-content-start justify-content-md-end">
                        ...
                        @endphp
                        @if (auth()->user()->hasPermission('faq.export'))
                            <a href="{{ route('super_admin.faqs.export') }}?{{ $params ? $params : '' }}"
                                class="btn btn-light">
                                <i class="fa fa-upload" aria-hidden="true"></i><span class="ml-2">Export</span>
                            </a>
                        @endif
                        @if (auth()->user()->hasPermission('faq.import'))
                        ...
                        @endif
                        @if (auth()->user()->hasPermission('faq.add'))
                            <a href="{{ route('super_admin.faqs.create') }}" class="btn btn-primary  ml-2">
                                ...
                                <tbody>
                                    @foreach ($faqs as $faq)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($faq->image)
                                                    <img src="{{ url($faq->image) }}" width="75px" height="75px"
                                                        alt="{{ $faq->slug }}">
                                                    &nbsp &nbsp
                                                @else
                                                    -
                                            ...
                                            <td>
                                                @if (!$faq->trashed())
                                                    <div class="d-flex">
                                                        @if (auth()->user()->hasPermission('faq.show'))
                                                            <a class="btn btn-primary"
                                                                href="{{ route('super_admin.faqs.show', ['faq' => $faq->id]) }}"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="View Detail"><i class="fa fa-eye"></i></a>
                                                        @endif
                                                        @if (auth()->user()->hasPermission('faq.edit'))
                                                            <a class="ml-2 btn btn-secondary"
                                                                href="{{ route('super_admin.faqs.edit', ['faq' => $faq->id]) }}"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="Edit Detail"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        {{-- edit --}}
                                                        @if (auth()->user()->hasPermission('faq.delete'))
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $faq->id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.faqs.destroy', ['faq' => $faq->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                ...
                                                @else
                                                    <div class="d-flex">
                                                        ...
                                                        <button type="button" class="btn btn-primary ml-2"
                                                            data-toggle="modal"
                                                            data-target="#restoreModal{{ $faq->id }}">
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $faq->id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.faqs.destroy_permanently', ['faq' => $faq->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <div class="modal-footer justify-content-between">
                                                    ...
                                                    <div class="modal fade" id="restoreModal{{ $faq->id }}"
                                                        style="display: none;" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.faqs.restore', ['faq' => $faq->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="modal-footer justify-content-between">
                                                                        <button type="button" class="btn btn-default"
