            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.lawyer_events.index' , $lawyer->id) }}">Events
                                </a></li>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $lawyer_event->name ? $lawyer_event->name : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Strats At</h6>
                                        <p class="mb-0 text-muted">{{ $lawyer_event->starts_at ? $lawyer_event->starts_at : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Ends At</h6>
                                        <p class="mb-0 text-muted">{{ $lawyer_event->ends_at ? $lawyer_event->ends_at : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Address Line 1</h6>
                                        <p class="mb-0 text-muted">{{ $lawyer_event->address_line_1 ? $lawyer_event->address_line_1 : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Address Line 2</h6>
                                        <p class="mb-0 text-muted">{{ $lawyer_event->address_line_2 ? $lawyer_event->address_line_2 : '--' }}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted"> 
                                            @if ($lawyer_event->image)
                                                <img class="mt-3" src="{{ url($lawyer_event->image) }}" width="75px" height="75px"
                                                    alt="{{ $lawyer_event->slug }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $lawyer_event->slug ? $lawyer_event->slug : '--' }}</p>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $lawyer_event->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($lawyer_event->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{!! $lawyer_event->description !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
