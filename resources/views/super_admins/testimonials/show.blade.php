                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $testimonial->name ? $testimonial->name : '--' }}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted"> 
                                            @if ($testimonial->image)
                                                <img class="mt-3" src="{{ url($testimonial->image) }}" width="75px" height="75px"
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $testimonial->slug ? $testimonial->slug : '--' }}</p>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $testimonial->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($testimonial->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{!! $testimonial->description !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
