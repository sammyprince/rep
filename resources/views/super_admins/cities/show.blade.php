                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $city->name ? $city->name : '--' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $city->country->name ? $city->country->name : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">State</h6>
                                        <p class="mb-0 text-muted">{{ $city->state->name ? $city->state->name : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Longitude</h6>
                                        <p class="mb-0 text-muted">{{ $city->longitude ? $city->longitude : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Latitude</h6>
                                        <p class="mb-0 text-muted">{{ $city->latitude ? $city->latitude : '--' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted"> 
                                            @if ($city->image)
                                                <img class="mt-3" src="{{ url($city->image) }}" width="75px" height="75px"
                                                    alt="{{ $city->slug }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $city->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($city->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{!! $city->description !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
