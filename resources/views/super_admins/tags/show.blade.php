                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $tag->name ? $tag->name : '--' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted"> 
                                            @if ($tag->image)
                                                <img class="mt-3" src="{{ url($tag->image) }}" width="75px" height="75px"
                                                    alt="{{ $tag->slug }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $tag->slug ? $tag->slug : '--' }}</p>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $tag->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($tag->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
