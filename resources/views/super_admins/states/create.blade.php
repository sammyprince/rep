        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.states.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                @if (isset($countries))
                                ...
                                <div class="col-md-12 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" name="name" value="{{ old('name') }}" class="form-control @if ($errors->has('name')) is-invalid @endif" id="InputName" placeholder="Enter Name" aria-describedby="NameError" aria-invalid="true">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="longitude" value="{{ old('longitude') }}" class="form-control @if ($errors->has('longitude')) is-invalid @endif" id="InputLongitude" placeholder="Enter Longitude" aria-describedby="LongitudeError" aria-invalid="true">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="latitude" value="{{ old('latitude') }}" class="form-control @if ($errors->has('latitude')) is-invalid @endif" id="InputLatitude" placeholder="Enter Latitude" aria-describedby="LatitudeError" aria-invalid="true">
