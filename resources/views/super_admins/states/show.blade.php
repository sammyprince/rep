                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $state->name ? $state->name : '--' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $state->longitude ? $state->longitude : '--' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Longitude</h6>
                                        <p class="mb-0 text-muted">{{ $state->country->name ? $state->country->name : '--' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Latitude</h6>
                                        <p class="mb-0 text-muted">{{ $state->latitude ? $state->latitude : '--' }}</p>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted"> 
                                            @if ($state->image)
                                                <img class="mt-3" src="{{ url($state->image) }}" width="75px" height="75px"
                                                    alt="{{ $state->slug }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $state->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div> 
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($state->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{!! $state->description !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
