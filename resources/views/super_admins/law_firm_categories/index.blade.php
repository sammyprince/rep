            ...
            <div class="row align-items-center mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-md-5">
                    <div class="d-flex justify-content-start justify-content-md-end">
                        ...
                        @endphp
                        @if (auth()->user()->hasPermission('law_firm_category.export'))
                            <a href="{{ route('super_admin.law_firm_categories.export') }}?{{ $params ? $params : '' }}"
                                class="btn btn-light">
                                <i class="fa fa-upload" aria-hidden="true"></i><span class="ml-2">Export</span>
                            </a>
                        @endif
                        @if (auth()->user()->hasPermission('law_firm_category.import'))
                        ...
                        @endif
                        @if (auth()->user()->hasPermission('law_firm_category.add'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($law_firm_category->image)
                                                    <img src="{{ url($law_firm_category->image) }}" width="75px"
                                                        height="75px" alt="{{ $law_firm_category->slug }}">
                                                    &nbsp &nbsp
                                                @else
                                                    -
                                                @endif
                                            ...
                                            <td>
                                                @if (!$law_firm_category->trashed())
                                                    <div class="d-flex">
                                                        @if (auth()->user()->hasPermission('law_firm_category.show'))
                                                            <a class="btn btn-primary"
                                                                href="{{ route('super_admin.law_firm_categories.show', ['law_firm_category' => $law_firm_category->id]) }}"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="View Detail"><i class="fa fa-eye"></i></a>
                                                        @endif
                                                        @if (auth()->user()->hasPermission('law_firm_category.edit'))
                                                            <a class="ml-2 btn btn-secondary"
                                                                href="{{ route('super_admin.law_firm_categories.edit', ['law_firm_category' => $law_firm_category->id]) }}"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="Edit Detail"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        {{-- edit --}}
                                                        @if (auth()->user()->hasPermission('law_firm_category.delete'))
                                                            <button type="button" class="btn btn-danger ml-2"
                                                                data-toggle="modal"
                                                                data-target="#deleteModal{{ $law_firm_category->id }}"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="Delete">
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $law_firm_category->id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.law_firm_categories.destroy', ['law_firm_category' => $law_firm_category->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                ...
                                                @else
                                                    <div class="d-flex">
                                                        ...
                                                        <button type="button" class="btn btn-primary ml-2"
                                                            data-toggle="modal"
                                                            data-target="#restoreModal{{ $law_firm_category->id }}">
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $law_firm_category->id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.law_firm_categories.destroy_permanently', ['law_firm_category' => $law_firm_category->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <div class="modal-footer justify-content-between">
                                                    ...
                                                    <div class="modal fade" id="restoreModal{{ $law_firm_category->id }}"
                                                        style="display: none;" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form
                                                                    action="{{ route('super_admin.law_firm_categories.restore', ['law_firm_category' => $law_firm_category->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="modal-footer justify-content-between">
                                                                        <button type="button" class="btn btn-default"
