        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.law_firms.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                                ...
                                                @if (count($law_firm_categories) > 0)
                                                    ...
                                                    @foreach ($law_firm_categories as $law_firm_category)
                                                        <option value="{{ $law_firm_category->id }}"
                                                            {{ old('law_firm_category_ids') == $law_firm_category->id ? 'selected' : '' }}>
